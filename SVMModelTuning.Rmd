...
```{r}
training <- read.csv('https://raw.githubusercontent.com/Ayzhamal/Spring_2019_Research/master/datasets/dixon_h1esc%20dataset/training_set.csv',header = TRUE)
...
```{r}
testing = read.csv("https://raw.githubusercontent.com/Ayzhamal/Spring_2019_Research/master/datasets/dixon_h1esc%20dataset/testing_set.csv")
...
do.RadialKernelSVM <- function(training)
{
  ...
  svm.Fit <- caret::train(class ~ ., data= training,
      method = 'svmRadial', 
      metric ='Accuracy',
      tuneGrid= grid,
