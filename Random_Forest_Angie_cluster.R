...
library(data.table)
training <- read.csv("https://raw.githubusercontent.com/Ayzhamal/Spring_2019_Research/master/datasets/rao_nhek_10kb%20dataset/training_set.csv",header = TRUE)
...
testing = read.csv("https://raw.githubusercontent.com/Ayzhamal/Spring_2019_Research/master/datasets/rao_nhek_10kb%20dataset/testing_set.csv", header = TRUE)
